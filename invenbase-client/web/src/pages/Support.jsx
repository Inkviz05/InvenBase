  ...
  return (
    <div style={{ maxWidth: '900px' }}>
      ...
      {tab === TAB_CREATE && !isAdmin() && (
        <>
          <section style={{ background: 'var(--card-bg)', borderRadius: 'var(--card-radius)', padding: '24px', marginBottom: '24px', border: '1px solid var(--divider)' }}>
          ...
          <section style={{ background: 'var(--card-bg)', borderRadius: 'var(--card-radius)', padding: '24px', border: '1px solid var(--divider)' }}>
              ...
              {requests.map((req) => (
                ...
                >
                  ...
                  {isAdmin() && replyingTo === req.id && req.status !== 'closed' && (
                    <form onSubmit={handleReplySubmit} style={{ marginTop: '20px', padding: '20px', background: 'var(--card-bg)', borderRadius: 'var(--card-radius)', border: '1px solid var(--divider)' }}>
