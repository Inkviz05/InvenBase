...
public final class NotificationCollapsedBinding implements ViewBinding {
  ...
  private NotificationCollapsedBinding(@NonNull LinearLayout rootView,
      @NonNull TextView notificationBody, @NonNull ImageView notificationLogo,
  ...
  public static NotificationCollapsedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.notification_logo;
      ImageView notificationLogo = ViewBindings.findChildViewById(rootView, id);
      ...
      return new NotificationCollapsedBinding((LinearLayout) rootView, notificationBody,
          notificationLogo, notificationTitle);
    }
